...
export function PendingSongItem({id, title, artists, time, bpm, handleQueue, handleReject}: SongItemProps) {
        ...
        <div className='flex flex-row items-center px-5 h-[100px] w-[300px] lg:w-[600px] rounded-xl my-4 border hover:border-black justify-between'>
            ...
            <div className='flex items-center gap-2 pl-5'>
                <div className='hidden lg:flex flex-col items-end px-2'>
                    <p className='text-gray-400 text-sm'>{time && new Date(time).toLocaleTimeString('en-GB', { hour: '2-digit', minute: '2-digit', second: '2-digit' })}</p>
                    <span className='text-gray-400 text-xs border w-fit px-1'>{bpm} BPM</span>
                </div>
